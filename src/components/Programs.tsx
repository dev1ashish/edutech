      ...
      <div className="container-x py-20 md:py-28">
        <header className="grid md:grid-cols-12 gap-8 items-end">
          ...
          <p className="md:col-span-5 text-lg text-[color:var(--ink-soft)] leading-relaxed">
            Six programme families, 500+ specialisations, four campuses — and one
            counsellor who knows the difference between them all.
          </p>
        </header>
        ...
        <p className="mt-10 text-center text-sm text-[color:var(--muted)]">
          ...
          — we cover 500+ programmes across the four universities.
        </p>
      </div>
    </section>
  );
