        ...
        <div className="uu2-header-inner">
          ...
          <div className="uu2-header-right">
            <div className="uu2-phones">
              <a href="tel:18002124201">
                <span aria-hidden>☎</span> 1800 212 4201
              </a>
              <a href="tel:18002124221">
                <span aria-hidden>☎</span> 1800 212 4221
              </a>
            </div>
            <a href="#apply" className="uu2-apply-btn">
