...
export const metadata: Metadata = {
  title: "Graphic Era Admissions 2026 — UG, PG & Doctoral Programmes",
  description:
    "Apply for Graphic Era (Deemed-to-be-University) Dehradun admissions 2026. 85+ programmes, NAAC A+, ₹61.99 LPA highest package, top recruiters Google, Adobe, Amazon.",
...
const FAQS = [
  ...
  {
    q: "Does Graphic Era outsource its admission process?",
    a: "Graphic Era (Deemed-to-be-University) does not outsource its admission process. The application form on this page reaches the official admissions team directly.",
  },
  {
        ...
        <div className="geu-container grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <div className="geu-callout">
              <strong>Note:</strong> Graphic Era (Deemed-to-be-University)
              doesn&apos;t outsource its admission process. The application form
              on this page reaches the official admissions team directly.
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            <div className="geu-form-card">
              ...
              <ThemedLeadForm
                ...
                successText="The Graphic Era admissions team will reach out within 24 hours with your eligibility, GECET schedule and document checklist."
                classes={{
                  form: "space-y-4",
                  field: "block",
                  label:
      ...
      <footer className="geu-footer">
        <div className="geu-container">
          ...
          <div className="geu-footer-bar">
            <p>© {new Date().getFullYear()} Graphic Era Admissions. All rights reserved.</p>
