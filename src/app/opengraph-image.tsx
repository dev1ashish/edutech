  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Free 1-on-1 admission counselling for UPES, Graphic Era, Uttaranchal
          University & Dev Bhoomi. Placements up to ₹61.99 LPA.
        </div>
        ...
        >
          <span>UPES · GRAPHIC ERA · UTTARANCHAL · DEV BHOOMI</span>
          <span style={{ color: "#0f3d2e" }}>edutechsolutions.in</span>
        </div>
      </div>
    ),
    { ...size }
