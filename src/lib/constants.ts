...
export const PROGRAMS: ProgramFamily[] = [
  {
    ...
    description:
      "B.Tech and M.Tech in CSE, AI/ML, Cybersecurity, Cloud, Mechanical, Civil and Petroleum across all four campuses.",
...
export const STATS = [
  ...
  { value: "500+", label: "Programmes spanning 4 universities" },
];
...
export const PROCESS: Step[] = [
  ...
  },
  {
    ...
    description:
      "A senior counsellor walks you through the four campuses, programme fit, fees, scholarships and career outcomes.",
...
export const FAQS = [
  {
    ...
    a: "Yes — students pay nothing. Edutech Solutions is compensated directly by the partner universities once a candidate enrols. There are no hidden charges, success fees, or paywalls during the counselling itself.",
  },
  {
    q: "Are you affiliated with these universities?",
    a: "We are an independent admission-counselling partner working with UPES, Graphic Era, Uttaranchal University and Dev Bhoomi University under formal partnership agreements. We are not owned by, or a part of, any of these institutions.",
  },
  {
  ...
  },
  {
    ...
    a: "Highest packages reported in 2025: Graphic Era ₹61.99 LPA, UPES ₹52 LPA (with 2,444 students placed across 800 companies), Uttaranchal University ₹1.5 Cr highest with 80%+ placement, and Dev Bhoomi with strong industry-aligned recruitment. Outcomes vary by programme and individual candidate.",
  },
  {
  ...
  },
  {
    ...
    a: "That's exactly when counselling helps most. We discuss your career goals, budget and lifestyle, then narrow the four campuses and dozens of programmes down to the 2-3 that genuinely fit you.",
  },
];

export const ADMITS = [
  { initials: "A.K.", city: "Dehradun", program: "B.Tech CSE", university: "UPES" },
  ...
  { initials: "S.N.", city: "Bareilly", program: "BCA", university: "Dev Bhoomi" },
  { initials: "I.J.", city: "Haldwani", program: "B.Pharm", university: "Graphic Era" },
  { initials: "T.R.", city: "Meerut", program: "BA LLB", university: "UPES" },
  { initials: "K.V.", city: "Saharanpur", program: "B.Des", university: "UPES" },
